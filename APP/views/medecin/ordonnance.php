<div class="prescription-paper shadow mx-auto bg-white p-5" id="ordonnanceContent">
    ...
    <div class="mb-5 p-3 bg-light rounded shadow-inner">
        <div class="d-flex justify-content-between align-items-center">
            <p class="mb-0">Patient : <strong id="nomPatientModal" class="fs-5 text-dark"></strong></p> <span class="badge bg-white text-dark border">Document Officiel</span>
        </div>
    </div>
    ...
    <div class="mb-5 pb-4 border-bottom">
        ...
        <p id="diagModal" class="fst-italic text-dark ps-3 border-start border-4 border-light"></p> </div>

    <div class="prescription-body">
        <h5 class="text-center fw-bold text-uppercase mb-5" style="letter-spacing: 2px;">Ordonnance</h5>
        <div id="prescModal" class="ps-4" style="line-height: 2; font-size: 1.1rem;"></div> </div>
