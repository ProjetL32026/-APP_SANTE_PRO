 ...
 * Intégration du système de Ticket et Sécurité
 */
...
// 4. Récupération des variables de navigation
$page = $_GET['page'] ?? 'accueil';
$controller = $_GET['controller'] ?? '';
$action = $_GET['action'] ?? null;
$role = $_SESSION['role'] ?? $_SESSION['user_role'] ?? null;

// 5. Bloc de détection Connexion / Inscription
 ...
 */ else {
    switch ($page) {
        ...
        // --- TA PARTIE : SÉCURITÉ / TICKET / EMAIL ---
        case 'ticket':
